...
import { Structure, Queries as Q, StructureElement, StructureSelection, StructureSymmetry, StructureQuery, StructureProperties as SP } from '../mol-model/structure.js';
// import { Segmentation, OrderedSet } from '../mol-data/int.js'
import { to_mmCIF } from '../mol-model/structure/export/mmcif.js';
import { Vec3 } from '../mol-math/linear-algebra.js';
import { trajectoryFromMmCIF, MmcifFormat } from '../mol-model-formats/structure/mmcif.js';
...
export async function readCIF(path) {
...
export async function getBcif(pdbId) {
