...
(function (Mesh) {
    ...
    function createValues(mesh, transform, locationIt, theme, props) {
        ...
        return {
            ...
            uInteriorColor: mol_util_1.ValueCell.create((0, interior_1.getInteriorColor)(props.interior, (0, linear_algebra_1.Vec4)())),
            uInteriorSubstance: mol_util_1.ValueCell.create((0, interior_1.getInteriorSubstance)(props.interior, (0, linear_algebra_1.Vec4)())),
    ...
    function updateValues(values, props) {
        ...
        mol_util_1.ValueCell.update(values.uInteriorColor, (0, interior_1.getInteriorColor)(props.interior, values.uInteriorColor.ref.value));
        mol_util_1.ValueCell.update(values.uInteriorSubstance, (0, interior_1.getInteriorSubstance)(props.interior, values.uInteriorSubstance.ref.value));
    }
