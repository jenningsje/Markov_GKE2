...
import { CartoonRepresentationProvider } from '../../mol-repr/structure/representation/cartoon.js';
import { trajectoryFromMmCIF } from '../../mol-model-formats/structure/mmcif.js';
import { MolecularSurfaceRepresentationProvider } from '../../mol-repr/structure/representation/molecular-surface.js';
import { BallAndStickRepresentationProvider } from '../../mol-repr/structure/representation/ball-and-stick.js';
import { GaussianSurfaceRepresentationProvider } from '../../mol-repr/structure/representation/gaussian-surface.js';
...
import { MembraneOrientationRepresentationProvider } from '../../extensions/anvil/representation.js';
...
canvas3d.input.move.pipe(throttleTime(100)).subscribe(({ x, y }) => {
    var _a;
    const pickingId = (_a = canvas3d.identify(Vec2.create(x, y))) === null || _a === void 0 ? void 0 : _a.id;
    let label = '';
    if (pickingId) {
